...
// Get collection statistics - MUST BE BEFORE /:id routes
...
// Import collection - MUST BE BEFORE /:id routes
...
router.post(
  '/:id/requests/:requestId/duplicate',
  verifyToken,
  async (req: any, res: any) => {
    try {
      const { id, requestId } = req.params;
