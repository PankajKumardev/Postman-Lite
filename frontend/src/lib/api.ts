...
export async function fetchSaved(params?: { page?: number; limit?: number }) {
  ...
  return api(`/api/requests/saved${q.size ? `?${q.toString()}` : ''}`, {
    method: 'GET',
  });
}
...
export async function createCollectionRequest(
  ...
  return api(`/api/collections/${collectionId}/requests`, {
    method: 'POST',
    body: JSON.stringify(payload),
  });
}
...
export async function updateCollectionRequest(
  ...
  return api(`/api/collections/${collectionId}/requests/${requestId}`, {
    method: 'PUT',
    body: JSON.stringify(payload),
  });
}
...
export async function executeCollectionRequest(
  ...
  return api(`/api/collections/${collectionId}/requests/${requestId}/execute`, {
    method: 'POST',
  });
}

export async function duplicateCollectionRequest(
  collectionId: number,
  requestId: number
) {
  return api(
...
export async function importCollection(payload: { data: any; name?: string }) {
  return api('/api/collections/import', {
    method: 'POST',
    body: JSON.stringify(payload),
  });
}
...
export async function bulkExecuteCollectionRequests(
  collectionId: number,
  requestIds: number[]
) {
...
export async function bulkDeleteCollectionRequests(
  collectionId: number,
  requestIds: number[]
) {
...
export async function bulkUpdateCollectionRequests(
  collectionId: number,
  requestIds: number[],
  updates: any
) {
